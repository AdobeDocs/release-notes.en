...
<!-- <p> <b>Instructions:</b> This file is the template for the monthly RNs. To update all links, open this file in notepad++, search for <span class="filepath"> 10152015 </span> and replace all occurrences with the current file name (usually release date). When adding content, edit only the tables and Fixes ULs. Do not overwrite Concepts, Sections, or the topic maps ULs. </p> -->
...
* [ Marketing Cloud and Core Services ](10152015.md#marketingcloud)
* [ Analytics ](10152015.md#analytics)
* [ Audience Manager ](10152015.md#aam)
* [ Social ](10152015.md#social)
* [ Target ](10152015.md#target)
* [ Media Optimizer ](10152015.md#mediaoptimizer)
* [ Campaign ](10152015.md#campaign)
* [ Experience Manager ](10152015.md#experiencemanager)
* [ Key Documentation Updates in 2015 ](10152015.md#docupdates)
* [ Key Features Released in 2014 ](11132014.md#key_features)
* [ Mobile Services ](10152015.md#marketingcloud/mobile)
* [ Data Connectors ](10152015.md#marketingcloud/data_connectors)
* [ Dynamic Tag Management ](10152015.md#marketingcloud/dtm)
* [ Marketing Cloud ID Service ](10152015.md#marketingcloud/mcvid)
## Marketing Cloud
      15.10 {#marketing_cloud_interface}
...
[ Top ](10152015.md#marketingcloud)
...
>[!IMPORTANT]
>
>In January 2016, Adobe will disable SSL v3 protocol support for security purposes, and end SSL v3 traffic for`keyword  Adobe Analytics` data collection. Adobe will be reaching out to customers that are significantly impacted by this action soon.

* [ New Features in Analytics ](10152015.md#analytics/features_analytics)
* [ Analytics Fixes ](10152015.md#analytics/analyticsfixes)
## New Features and Functionality Changes in 
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 <tgroup cols="2"> 
  ...
  <tbody> 
   ...
   <tr> 
    <td colname="col1"> <p>Reports &amp; Analytics: E-Commerce Tracking</p> </td> 
   ...
   <tr> 
    <td colname="col1"> <p>Reports &amp; Analytics: Page Views metric</p> </td> 
   ...
   <tr> 
    <td colname="col1"> <p>Reports &amp; Analytics: Hierarchy Views metric</p> </td> 
   ...
   <tr> 
    <td colname="col1"> <p>Reports &amp; Analytics: Real-Time reports</p> </td> 
   ...
   <tr> 
    <td colname="col1"> <p>Reports &amp; Analytics: Hide metrics and events</p> </td> 
   ...
   <tr> 
    <td colname="col1"> <p>Reports &amp; Analytics: Export to CSV</p> </td> 
...
* Fixed an issue in `wintitle  Audience Marketplace` to prevent different buyers from the same organization from making multiple access requests for a feed if a request has already been submitted. (AAM-21261)
* Made changes to improve the accuracy of the trait overlap diagram in `wintitle  Audience Marketplace`. (AAM-20391)
**New and Revised Documentation**

New documentation describes how to pass in data provider IDs and user IDs with `codeph  d_cid` and `codeph  d_cid_ic`. These new variables replace `codeph  d_dpid` + `codeph  d_dpuuid` combinations, which are still supported but considered deprecated. See [ CID Replaces DPID and DPUUID ](https://marketing.adobe.com/resources/help/en_US/aam/?f=cid.html).
...
* Fixed an issue that caused incorrect data to display for LinkedIn posts in the `wintitle  Properties` report.
* Fixed an issue that caused the `wintitle  Properties Overview` export to return the incorrect number of LinkedIn posts.
