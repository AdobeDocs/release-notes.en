...
| ------------- | ------------- | ------------- | ------------- |
| [!DNL CX Enterprise] | July 10, 2026 | [CX Enterprise central UI & administration](https://experienceleague.adobe.com/en/docs/core-services/interface/more-resources/release-notes){target="_blank"} | <ul><li>CX Enterprise support for Federate Guest accounts (July 9)</li><li>Agentic AI usage monitoring</li><li>Adobe CX Enterprise interface refresh (dark mode, improved accessibility)</li></ul> |
| [!DNL Adobe Journey Optimizer B2B Edition] | July 10, 2026 | [Journey Optimizer B2B Edition release notes](https://experienceleague.adobe.com/en/docs/journey-optimizer-b2b/user/release-notes){target="_blank"} | <ul><li>Support for external action journey nodes for person journeys</li><li>Support for external split path journey nodes for person journeys</li><li>WhatsApp messaging from account journeys via the Meta Cloud API</li><li>Firefly and approved third-party image model integration</li><li>Person journeys (Beta) Overview tab with journey analytics</li></ul> |
| [!DNL Adobe Workfront] | Q2/Q3 2026 | [Adobe Workfront product releases](https://experienceleague.adobe.com/en/docs/workfront/using/product-announcements/product-releases/release-26-q3/26-q3-release-overview){target="_blank"} | <ul><li>View Adobe enterprise storage usage (Storage Overview in Setup)</li><li>Linked assets display AEM Assets status badges in Documents area</li><li>Predefined views added to Requests list and My Requests widget</li><li>Workfront API version 22 released</li></ul> |
| [!DNL Adobe Campaign Classic] v7 | June 2026 | [[!DNL Campaign Classic] release notes](https://experienceleague.adobe.com/en/docs/campaign-classic/using/release-notes/latest-release){target="_blank"} | <ul><li>Security updates (v7.4.3 June build)</li><li>Debian 13 and PostgreSQL 17 upgrades</li></ul> |
| [!DNL Adobe Journey Optimizer] | June 2026 | [[!DNL Journey Optimizer] release notes](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/whats-new/release-notes){target="_blank"} | <ul><li>Journey Simulation (General Availability)</li><li>Journey Fragments (General Availability)</li><li>Journey path optimization – Targeting (General Availability)</li><li>AI Assistant for Journey Expressions (Public Beta)</li><li>Decisioning support in the Direct Mail channel</li><li>URL parameter encryption for email links (General Availability)</li></ul> |
...
| [!DNL Adobe Customer Journey Analytics] | June 25, 2026 | [Customer Journey Analytics release notes](https://experienceleague.adobe.com/en/docs/analytics-platform/using/releases/latest?lang=en#releases){target="_blank"} | <ul><li>Data Mirror (change data capture from Snowflake, Azure Databricks, and Google BigQuery)</li><li>Validate your data in AI Assistant</li></ul> |
| [!DNL Adobe Experience Manager] as a Cloud Service | June 25, 2026 | [Current Release Notes for Adobe Experience Manager as a Cloud Service](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/release-notes/release-notes/release-notes-current){target="_blank"} | <ul><li>Visual Content Fragments (render Content Fragment output as formatted HTML)</li><li>Open Photoshop (.psd) assets in the Adobe Express embedded editor</li><li>Import Adobe Illustrator and InDesign assets from AEM Assets into Adobe Express</li><li>Dispatcher local MCP server now included in the AEM SDK</li></ul> |
| [!DNL Experience Platform] Mobile SDK | June 22, 2026 | [[!DNL Experience Platform] Mobile SDK release notes](https://developer.adobe.com/client-sdks/documentation/release-notes/){target="_blank"} | <ul><li>Android Core 3.7.1: fixed an in-app message freeze/crash on plain Activity hosts</li><li>Android Messaging 3.10.0: push receive tracking support</li><li>Android/iOS Brand Concierge: event tracking system, configurable feedback, and chat top bar image support</li><li>React Native Messaging 7.4.0: UI components for Journey Optimizer Inbox and Content Cards (April 21, 2026)</li></ul> |
| [!DNL Adobe Target] | June 17, 2026 | [[!DNL Adobe Target] release notes](https://experienceleague.adobe.com/en/docs/target/using/release-notes/release-notes){target="_blank"} | <ul><li>Fixed an error shown when an activity uses audiences deleted at the source</li><li>Fixed missing Analytics for Target (A4T) reports</li><li>Restored Save & Close in the updated Target UI</li><li>Fixed QA URLs and localization issues in the updated Target UI</li></ul> |
| [!DNL Adobe Experience Platform and Real-Time CDP] | June 16, 2026 | [[!DNL Experience Platform] release notes](https://experienceleague.adobe.com/en/docs/experience-platform/release-notes/latest){target="_blank"} | <ul><li>Agent Orchestrator: Validate your data in AI Assistant</li><li>Destinations (Azure Private Link, array export as enrichment attributes, Google Ad Manager 360 GA)</li><li>Experience Data Model (XDM) schema inventory enhancements</li><li>Real-Time Customer Profile batch ingestion validation</li><li>Run and Operate anti-pattern detection and health checks</li><li>Segmentation Service persistent split support</li><li>Sources: general availability of the LAVA source</li></ul> |
| [!DNL Adobe Campaign] Web user interface | June 16, 2026 | [Campaign Web UI release notes](https://experienceleague.adobe.com/en/docs/campaign-web/v8/release-notes/release-notes){target="_blank"} | <ul><li>Export data directly from any list screen, including tracking logs</li><li>Deduplication and End workflow activities now support multiple inbound transitions</li></ul> |
| [!DNL Adobe LLM Optimizer] | June 5, 2026 | [LLM Optimizer release notes](https://llmo.now/articles/release-notes){target="_blank"} | <ul><li>Referral Traffic Insights Enhancements</li><li>Optimize at Edge: [!DNL Claude] Support</li><li>CDN Onboarding Enhancements</li></ul> |
| [!DNL Adobe Experience Manager] [!DNL Cloud Manager] | June 4, 2026 | [Experience Manager Cloud Manager release notes](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-manager/content/release-notes/current){target="_blank"} | <ul><li>Customer-managed keys (CMK) self-service</li><li>Delete production programs with soft delete (30-day restore window)</li><li>Edge Delivery Services with AEM Authoring</li><li>Environment variable limit increased to 400</li></ul> |
...
| [!DNL Adobe Campaign] v8 | March 11, 2026 | [[!DNL Campaign] v8 release notes](https://experienceleague.adobe.com/en/docs/campaign/campaign-v8/releases/release-notes){target="_blank"} | <ul><li>Debian 13 and PostgreSQL 17 upgrades</li><li>Security and stability fixes</li></ul> |
