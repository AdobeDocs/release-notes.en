...
| [!DNL Adobe Experience Manager] as a Cloud Service | May 28, 2026 | [Current Release Notes for Adobe Experience Manager as a Cloud Service](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/release-notes/release-notes/release-notes-current){target="_blank"} | <ul><li>AI Translation Integration via LLMs</li><li>Dynamic Media multiple captions and audio tracks for video assets</li><li>Adaptive Forms rule enhancements (AND/OR logic for File Attachment conditions)</li><li>Quiet Hours and Update Free Periods via AEM AI Assistant</li><li>Versioning support in Forms Manager</li></ul> |
...
| [!DNL Adobe Journey Optimizer] | June 2026 | [[!DNL Journey Optimizer] release notes](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/whats-new/release-notes){target="_blank"} | <ul><li>AI Assistant for Journey Expressions (Public Beta)</li><li>Automatic completion for non-recurring Read Audience journeys</li><li>Certificate-Based Custom Authentication in custom actions</li><li>Journey Simulation (Limited Availability)</li><li>Journey Fragments (Limited Availability)</li></ul> |
