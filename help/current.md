...
* [[!DNL Adobe Analytics]](#analytics) (**February**)
* [[!DNL Adobe Customer Journey Analytics]](#cja) (**February**)
* [[!DNL Adobe Streaming Media Analytics]](#sma)
* [[!DNL Adobe Experience Manager]](#aem) (**January**)
* [[!DNL Adobe LLM Optimizer]](#llm-optimizer)
* [[!DNL Adobe Brand Concierge]](#brand-concierge)
* [[!DNL Adobe Commerce]](#commerce)
* [[!DNL Adobe Target]](#target) (**January**)
* [[!DNL Adobe Campaign]](#ac) (**January**)
* [[!DNL Adobe Journey Optimizer]](#journey-opt) (**February**)
* [[!DNL Adobe Journey Optimizer B2B Edition]](#ajo-b2b) (**February**)
* [[!DNL Adobe Marketo Engage]](#marketo) (**January**)
* [[!DNL Adobe Workfront]](#workfront) (**January**)
* [[!DNL Adobe GenStudio for Performance Marketing]](#genstudio-marketing) (**January**)
* [[!DNL Adobe Mix Modeler]](#mix-modeler)
* [[!DNL Adobe Advertising]](#advertising) (**January**)
* [[!DNL Adobe Pass]](#pass)
...
|---------|----|----|-----------|
|January 2026|[Customer Journey Analytics BI extension connection issues with non-expiring credentials](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29891)|New article| Learn about the solutions to the issue when non-expiring credentials in Adobe Experience Platform must have correct Customer Journey Analytics access and data view permissions to work with BI tools.|
|January 2026|[Streaming ingestion fails due to an invalid schema reference](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29710)|New article| Learn about the solutions to the issue when streaming ingestion fails because the schema reference in the payload is incorrect or malformed in Adobe Experience Platform.|
|January 2026|[[!DNL Databricks] connector fails due to expired SAS token in AEP](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29715)|New article| Learn about the solutions to the issue when the [!DNL Databricks] connector stops working after infrastructure changes or when the SAS ([!DNL Shared Access Signature]) token in the Spark configuration expires or is refreshed in AEP.|
|January 2026|[Incremental exports to S3 destination not exporting mapped audience in AEP](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29725)|New article| Learn about the solutions to the issue when incremental exports to an Amazon S3 destination result in zero records exported even though the mapped audience shows valid incremental counts in AEP.|
|January 2026|[Marketing actions list not visible in Adobe Experience Platform](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29744)|New article| Learn about the solutions to the issue when the marketing actions list doesn't appear and the page shows up blank when configuring an Ad destination because the affected user doesn't have the right Data Governance permissions in Adobe Experience Platform.|
|January 2026|[False delay alerts for source flow runs in AEP](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29745)|New article| Learn about the solutions to the issue when alerts for source flow run delays appear even when dataflow runs finish successfully because the alerting system's monitoring signals don't always match actual run metrics in Adobe Experience Platform.|
|January 2026|[Alerts not triggering for streaming dataflow ingestion failures in Adobe Experience Platform](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29762)|New article| Learn about the solutions to the issue when alerts for source flow failures don't work for streaming dataflows in Adobe Experience Platform.|
|January 2026|[Authentication error when exporting segment to [!DNL LiveRamp] in AEP](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29774)|New article| Learn about the solutions to the issue when an authentication error occurs while exporting a segment from the production sandbox to the [!DNL LiveRamp] onboarding destination in Adobe Experience Platform.|
|January 2026|[Profiles don't sync to Google Customer Match in AEP](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29806)|New article| Learn about the solutions to the issue when only a small subset of profiles sync successfully when activating an audience to Google Customer Match because profiles lack Google-supported identity attributes or have incorrect mappings.|
|January 2026|[[!DNL Meta Pixel] extension loads JavaScript before consent in AEP](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29840)|New article| Learn about the solutions to the issue when the [!DNL Meta Pixel] extension in Adobe Experience Platform loads the `fbevents.js` script before consent is provided.|
|January 2026|[Integrate [!DNL The Trade Desk] with Adobe Experience Platform and collect [!DNL The Trade Desk ID]](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29847)|New article| Learn about the solutions to the issue when there is uncertainty in collecting and mapping [!DNL The Trade Desk ID] through Web SDK when integrating [!DNL The Trade Desk] with Adobe Experience Platform.|
...
|Published|Name|Type|Description|
|---------|--------|---------|---------|
|January 2026|[DASH/HLS adaptive streaming returns *Advanced Streaming is not enabled* error in AEM Dynamic Media](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29657)|New article| Learn about the solutions to the issue when accessing DASH adaptive streaming returns an *Advanced Streaming is not enabled* error due to incorrect URL format for the MPD file in AEM Dynamic Media.|
|January 2026|[Adobe Experience Manager: Experience Fragment (XF) copy and paste operation fails with Error popup](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29837)|New article| Learn about the solutions to the issue when copying and pasting an Experience Fragment (XF) causes an error popup to appear and the XF doesn't paste.|
...
|January 2026|[TCP Locator fails to start due to Java version mismatch in AEM](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28132)|New article| Learn about the solutions to the issue when the TCP Locator fails to start because it requires JDK 17 or higher after the SP22 Hotfix in a clustered environment.|
|January 2026|[ZIP assets return 404 on [!UICONTROL Publish] in AEM as a Cloud Service or AEM 6.5 with Dispatcher](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28174)|New article| Learn about the solutions to the issue when ZIP files uploaded to AEM DAM show as published in [!UICONTROL Author] but return a 404 error when accessed on [!UICONTROL Publish] because Dispatcher blocks ZIP requests by default.|
|January 2026|[Missing error logs when forwarding AEM logs to an HTTP endpoint via [!DNL Nginx]](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28164)|New article| Learn about the solutions to the issue when forwarding AEM logs to a custom HTTP endpoint using [!DNL Nginx] results in missing error exception logs because the HTTP endpoint is temporarily unavailable or responds slowly.|
|January 2026|[Understanding Adobe Launch (Tags) environment mapping in AEM as a Cloud Service](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28165)|New article| Learn about the solutions to the issue when configuring Adobe Launch in AEM as a Cloud Service shows only Staging and Production tabs, causing confusion about which Launch library is used by each environment.|
|January 2026|[Inconsistent Dispatcher `vhost` configuration across AEM as a Cloud Service publish pods](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29602)|New article| Learn about the solutions to the issue when some AEM as a Cloud Service publish pods don't apply updated Dispatcher `vhost` configuration consistently resulting in *HTTP 301* redirects and infinite redirect loops because required hosts aren't explicitly defined.|
|January 2026|[Redirect properties don't roll out to AEM live copies](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29707)|New article| Learn about the solutions to the issue when redirect settings configured on blueprint pages don't propagate to live copies during rollout because the default MSM action excludes redirect-related properties.|
|January 2026|[Setting up an EDS project with the correct Adobe repository in AEMaaCS](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28055)|New article| Learn about the solutions to the issue when setting up an Edge Delivery Services project in AEMaaCS requires using the correct Adobe boilerplate repository.|
...
|Published|Name|Type|Description|
|---------|--------|---------|---------|
|January 2026|[[!DNL Quality Patches Tool] (QPT)](https://experienceleague.adobe.com/en/docs/commerce-operations/tools/quality-patches-tool/patches-available-in-qpt/patches-available-in-qpt-tool-overview)|New articles| New articles on how to apply patches available in QPT 1.1.75 were published and can be found in their respective sections.|
|January 2026|[[!DNL Site-Wide Analysis Tool] report fails to open with *400 Bad Request - Request Header Or Cookie Too Large* error](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27906)|New articles| Learn about the solutions to the issue when the [!DNL Site-Wide Analysis Tool] report fails to open and displays a *400 Bad Request error* because request headers or cookies exceed server configuration limits in Adobe Commerce Cloud.|
|January 2026|[Advanced Reporting troubleshooter for Adobe Commerce](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29603)|New articles| Learn about diagnosing and resolving Advanced Reporting issues in Adobe Commerce.|
|January 2026|[[!DNL Cloudflare] timeout and redirect issues in Adobe Commerce](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29759)|New articles| Learn about the solutions to the issue when [!DNL Cloudflare] configuration causes timeout and redirect problems in Adobe Commerce environments.|
|January 2026|[Database upload loses connection to [!DNL MySQL]](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29843)|New articles| Learn about the solutions to the issue when the database upload loses connection to [!DNL MySQL].|
|January 2026|[Error enabling Image Optimization in Adobe Commerce](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29890)|New articles| Learn about the solutions to the issue when [!DNL Fastly] Image Optimization ([!DNL Fastly] IO) is disabled by default with a notification to contact [!DNL Fastly] to enable image optimization.|
|January 2026|[The `var/export` folder permission issue in Adobe Commerce on cloud infrastructure](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29895)|New articles| Learn about the solutions to the issue when product data can't be exported due to file permissions issues on the server in the `var/export/email` folder.|
...
|Published|Name|Type|Description|
|---------|----|----|-----------|
|January 2026|[Fixing inflated active profile counts in Adobe Campaign Managed Cloud](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29761)|New article| Learn about the solutions to the issue when multiple target mappings share the same log schema, causing unexpected increases in active profile counts in Adobe Campaign Managed Cloud.|
|January 2026|[Campaign Standard: A/B Testing deliveries still pending while the winner is selected](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29793)|New article| Learn about the solutions to the issue when A/B testing is concluded before all variants are delivered to recipients.|
|January 2026|[Campaign Classic: Exporting workflows causes the instance to crash](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29792)|New article| Learn about the solutions to the issue when exporting a custom campaign workflow in a package crashes the instance.|
