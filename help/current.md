...
And many more! View the complete listing of [upcoming](https://experienceleague.adobe.com/en/events) and [on-demand](https://experienceleague.adobe.com/en/docs/events/experience-league-recorded-events/overview) events on Experience League.
...
|Published|Name|Type|Description|
|---------|--------|---------|---------|
|February 2026|[Data Warehouse export contains values exceeding 255 bytes due to escape sequences](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29977)|New article| Learn about the solutions to the issue when Data Warehouse export contains field values that exceed the 255-byte limit because special characters are escaped with additional backslashes.|
...
|Published|Name|Type|Description|
|---------|----|----|-----------|
|February 2026|[Changing derived field triggers dataset type change error in CJA](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-30065)|New article| Learn about the solutions to the issue when Customer Journey Analytics displays an error when you add a [!UICONTROL Lookup] function to an existing derived field.|
|February 2026|[Understand and use the [!UICONTROL Person ID] dimension to resolve people count mismatches](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-30068)|New article| Learn about the solutions to the issue when people counts in a CJA connection using multiple datasets with different identity fields look wrong or are hard to explain.|
...
|Published|Name|Type|Description|
|---------|--------|---------|---------|
|February 2026|[Uploaded assets Not Available from Dynamic Media Scene7 delivery](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29939)|New article| Learn about the solutions to the issue when an asset uploaded into AEM and expected to be available from the DMS7 delivery servers isn't available.|
|February 2026|[Uploading files to a subfolder in a contribution folder fails for Brand Portal users](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29607)|New article| Learn about the solutions to the issue when Adobe Experience Manager Brand Portal prevents file uploads to the `New` subfolder in a contribution folder when permissions aren't properly assigned.|
|February 2026|[Adobe Experience Manager: [!UICONTROL Experience Fragment] (XF) copy and paste operation fails with error popup](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29837)|New article| Learn about the solutions to the issue when copying and pasting an [!UICONTROL Experience Fragment] (XF) causes an error popup and the XF won't paste.|
|February 2026|[Adobe Experience Manager: How to stop AEM emails to a user who no longer uses AEM](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29839)|New article| Learn about the solutions to the issue when a user continues to receive system or workflow emails even after they stop using AEM.|
|February 2026|[Adobe Experience Manager: Introduction to the [!UICONTROL Distribute Function]](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-30069)|New article| Learn about the solutions to the issue when you need to work with nodes that are difficult to manage through the regular publication flow or when you must resolve replication inconsistencies in AEMaaCS.|
|February 2026|[Error log warnings related to [!DNL LiveFyre] in Adobe Experience Manager (AEM)](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27571)|New article| Learn about the solutions to the issue when AEM on-premise error logs show repeated warnings because AEM tries to run a [!DNL LiveFyre] polling import job, and the importer no longer exists since Adobe discontinued [!DNL LiveFyre] functionality.|
|February 2026|[Updating SSL certificates in AEM 6.5: truststore and keystore reset](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28023)|New article| Learn about the solutions to the issue when an SSL certificate expires on an AEM 6.5 publish instance and the system shows an invalid keystore password error if the old credentials are missing.|
|February 2026|[Set up targeted cache eviction with multiple Dispatcher farms in AEM](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29672)|New article| Learn about the solutions to the issue when configuring multiple Dispatcher farms in AEM causes cache flush requests to route incorrectly when using localhost URLs.|
|February 2026|[`cq-dam-cfm-graphql` bundle activation failure after upgrade in AEM](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29892)|New article| Learn about the solutions to the issue when the `cq-dam-cfm-graphql` bundle fails to start after upgrading to AEM 6.5.21 and installing the Forms add-on package due to unresolved dependencies.|
|February 2026|[Enable TLS 1.3 for AEM 6.5.24 on [!DNL Windows Server 2022]](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29790)|New article| Learn about the solutions to the issue when TLS 1.3 isn't enabled by default in AEM 6.5.24 running on [!DNL Windows Server 2022] with [!DNL JBoss] even though the platform supports it.|
|February 2026|[Unable to disable backup mode after upgrade in AEM Forms JEE 6.5.23](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29885)|New article| Learn about the solutions to the issue when backup mode fails to disable after upgrading AEM Forms JEE to version 6.5.23.|
|February 2026|[Users automatically added to [!UICONTROL Contributors] group in AEMaaCS](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28145)|New article| Learn about the solutions to the issue when users who authenticate through Adobe IMS are automatically added to the [!UICONTROL Contributors] group in AEMaaCS even if `DefaultSyncHandler` configurations are set to prevent automatic group membership.|
|February 2026|[Live Copy pages don't publish when blueprint is activated or deactivated in AEMaaCS](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28187)|New article| Learn about the solutions to the issue when Live Copy target pages fail to publish automatically when the blueprint is activated or deactivated in AEMaaCS.|
|February 2026|[Unable to restore deleted assets after retention period in AEMaaCS](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29600)|New article| Learn about the solutions to the issue when deleted assets in AEMaaCS aren't recoverable through version history or timeline after the retention period ends.|
|February 2026|[Unable to view workflow registrations of other users in AEMaaCS](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29645)|New article| Learn about the solutions to the issue when you're unable to view workflow registrations created by other users in AEMaaCS and folder-level permissions don't grant this access.|
|February 2026|[Requests to CSRF token and custom servlet endpoints return 404 error in AEMaaCS](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29665)|New article| Learn about the solutions to the issue when requests to the CSRF token and custom servlet endpoints fail with 404 errors on AEMaaCS publish instances when CDN edge authentication blocks these paths.|
|February 2026|[[!UICONTROL Universal Editor] fails to load legacy AEM Sites without EDS](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29883)|New article| Learn about the solutions to the issue when [!UICONTROL Universal Editor] fails to load target pages for legacy AEM Sites that don't use [!UICONTROL Experience Data Service] (EDS) and displays a login screen or error message instead.|
|February 2026|[[!UICONTROL Workflow] Action Missing in [!UICONTROL Content Fragments] Console in AEMaaCS](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29896)|New article| Learn about the solutions to the issue when the [!UICONTROL Content Fragments] console in AEMaaCS doesn't display a workflow action in its [!UICONTROL Action Bar] by default and authors can't trigger workflows directly from the console.|
|February 2026|[Incorrect workflow count and unhealthy system status in AEMaaCS](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29905)|New article| Learn about the solutions to the issue when AEMaaCS displays incorrect running or completed workflow counts, which causes the system health indicator to show an unhealthy status.|
|February 2026|[Content hub - Lower environment isn't accessible](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-30064)|New article| Learn about the solutions to the issue when you have difficulty locating Content Hub lower environments after clicking to provision Content Hub for lower environments in Cloud Manager.|
|February 2026|[Content‑Security‑Policy header missing on AEM Author login endpoints](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29884)|New article| Learn about the solutions to the issue when the AEMaaCS Author login endpoints don't include a Content-Security-Policy (CSP) header, which security scans often flag.|
|February 2026|[Managing publication permissions for [!UICONTROL Experience Fragments] in AEMaaCS](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29669)|New article| Learn about the solutions to the issue when denying the publishing privilege for [!UICONTROL Experience Fragments] prevents users from publishing, but the [!UICONTROL Manage Publication] button still appears in the UI.|
|February 2026|[Unable to edit or add components in AEM Sites after assigning write access](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29692)|New article| Learn about the solutions to the issue when a user can't add new components or edit existing ones in the AEM Sites page editor even after being granted write access.|
...
|February 2026|[[!UICONTROL Advanced Reporting] troubleshooter for Adobe Commerce](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29603)|New article| Learn about the solutions to the issue when [!UICONTROL Advanced Reporting] issues in Adobe Commerce require diagnosis and resolution through targeted diagnostic questions.|
|February 2026|[APSB patch check shows as failed in Adobe Commerce on cloud infrastructure](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29734)|New article| Learn about the solutions to the issue when the [!UICONTROL Security Scan Tool] reports the APSB patch status as *FAIL* after upgrading Adobe Commerce on cloud infrastructure even though the patch is included in the version.|
|February 2026|[Enable cache to avoid performance degradation](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29888)|New article| Learn about the solutions to the issue when a slow site is caused by certain Adobe Commerce cache types being disabled.|
|February 2026|[Error enabling [!UICONTROL Image Optimization] in Adobe Commerce](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29890)|New article| Learn about the solutions to the issue when [!DNL Fastly] [!UICONTROL Image Optimization] (IO) is disabled by default with a notification to contact [!DNL Fastly] to enable image optimization.|
|February 2026|[The `var/export` folder permission issue in Adobe Commerce on cloud infrastructure](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29895)|New article| Learn about the solutions to the issue when you aren't able to export product data due to a file permissions issue in the `var/export/email` folder in Adobe Commerce on cloud infrastructure.|
|February 2026|[[!UICONTROL Extension Manager] shows no extensions in Adobe Commerce 2.3.x](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29897)|New article| Learn about the solutions to the issue when purchased [!DNL Marketplace] extensions don't appear in the [!UICONTROL Extension Manager] in Adobe Commerce 2.3.x.|
|February 2026|[Troubleshoot cron](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29907)|New article| Learn about the solutions to the issue when you have cron issues in Adobe Commerce and Magento Open Source, including update or upgrade remaining pending, PHP setting errors, or cron readiness check failures.|
|February 2026|[[!DNL Redis] unserialize error `setup:static-content:deploy`](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29908)|New article| Learn about the solutions to the issue when running the `setup:static-content:deploy` command triggers a [!DNL Redis] unserialize error during static content deployment in Adobe Commerce.|
|February 2026|[Stock status incorrect after [!UICONTROL Inventory Management] install](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29910)|New article| Learn about the solutions to the issue when stock status is incorrect on some sites after first installing or upgrading to have [!UICONTROL Inventory Management] in a multi-website Adobe Commerce environment.|
|February 2026|[[!DNL Redis] service crashed](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29915)|New article| Learn about the solutions to the issue when website slowness or outage occurs due to memory overflow in [!DNL Redis].|
|February 2026|[PWA Studio: [!DNL Venia] GraphQL queries to Adobe Commerce produce validation errors](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29920)|New article| Learn about the solutions to the issue when [!DNL Venia] storefront GraphQL queries to Adobe Commerce produce validation errors because [!DNL Venia]'s GraphQL queries are out of sync with the Adobe Commerce schema.|
|February 2026|[Importing upsell products doesn't update product links in Adobe Commerce on cloud infrastructure](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29955)|New article| Learn about the solutions to the issue when importing a CSV file with upsell, related, or cross-sell products in Adobe Commerce completes without errors, but doesn't update the product links as expected.|
|February 2026|[Restricted access to [!UICONTROL App Builder] and missing project templates in Adobe Admin Console](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-30011)|New article| Learn about the solutions to the issue when access to [!UICONTROL App Builder] and the **[!UICONTROL Create project from template]** option stays restricted because the account hasn't been added to the correct organization in the Adobe Admin Console.|
...
|Published|Name|Type|Description|
|---------|----|----|-----------|
|February 2026|[Adobe Campaign [!UICONTROL Delivery Throughput] report shows higher processed count](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29878)|New article| Learn about the solutions to the issue when the [!UICONTROL Delivery Throughput report] displays higher processed or sent-per-hour values that don't align with the success metrics shown in the delivery summary.|
|February 2026|[[!UICONTROL Broadlog ID] not sent to Adobe Analytics via Campaign Managed Cloud integration](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27962)|New article| Learn about the solutions to the issue when Adobe Campaign Managed Cloud doesn't send [!UICONTROL Broadlog IDs] to Adobe Analytics when using the standard workflow `webAnalyticsSendMetrics`.|
|February 2026|[Operating system and device version data missing in tracking logs Adobe Campaign Managed Cloud](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28131)|New article| Learn about the solutions to the issue when tracking logs in Adobe Campaign Managed Cloud show device and operating system family only, and the product doesn't include fields for operating system version or device model or version.|
|February 2026|[**[!UICONTROL Add language]** button missing in Campaign Web UI email builder](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29770)|New article| Learn about the solutions to the issue when the **[!UICONTROL Add language]** button is missing in the Adobe Campaign v8 Web UI email builder when editing an email delivery.|
|February 2026|[Delivery limit for language variants in Adobe Campaign v8](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29785)|New article| Learn about the solutions to the issue when a delivery is configured with more than 40 language variants in Adobe Campaign v8, which isn't supported.|
|February 2026|[Push delivery fails during workflow execution in Adobe Campaign Classic v8](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29871)|New article| Learn about the solutions to the issue when push delivery fails during workflow execution at the target preparation stage because workflow temporary tables are created in Postgres while delivery preparation runs in [!DNL Snowflake].|
|February 2026|[Authorization errors when sending deliveries in Adobe Campaign v8](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-30003)|New article| Learn about the solutions to the issue when non-admin users receive authorization errors when attempting to send or confirm deliveries linked to a campaign in Adobe Campaign v8, even when folder permissions are correctly assigned.|
