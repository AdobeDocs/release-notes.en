...
uuid: 4b45d90b-e640-4c34-b40b-d13dbc4630d0
index: n
internal: n
snippet: y
translate: y
...
<!-- <p> <b>Instructions:</b> This file is the template for the monthly RNs. To update all links, open this file in notepad++, search for <span class="filepath"> 10152015 </span> and replace all occurrences with the current file name (usually release date). When adding content, edit only the tables and Fixes ULs. Do not overwrite Concepts, Sections, or the topic maps ULs. </p> -->
 <!-- <b>Contacts and assignments:</b> https://wiki.corp.adobe.com/display/techpubs/Release+Notes --> October 2015
<!-- <p> 
 <note type="important">
...
* [ Mobile Services ](10152015.md#mobile)
* [ Data Connectors ](10152015.md#data_connectors)
* [ Dynamic Tag Management ](10152015.md#dtm)
* [ Marketing Cloud ID Service ](10152015.md#mcvid)
...
* [ New Features in Analytics ](10152015.md#features_analytics)
* [ Analytics Fixes ](10152015.md#analyticsfixes)
...
* Fixed an issue in ` Audience Marketplace` to prevent different buyers from the same organization from making multiple access requests for a feed if a request has already been submitted. (AAM-21261)
* Made changes to improve the accuracy of the trait overlap diagram in ` Audience Marketplace`. (AAM-20391)
...
* Fixed an issue that caused incorrect data to display for LinkedIn posts in the ` Properties` report.
* Fixed an issue that caused the ` Properties Overview` export to return the incorrect number of LinkedIn posts.
