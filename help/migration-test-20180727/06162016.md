...
uuid: 6611c4d4-bf45-4acc-9d49-d927beec4675
index: n
internal: n
snippet: y
translate: y
...
* [ Mobile Services ](06162016.md#mobile)
* [ Marketing Cloud ID Service ](06162016.md#mcvid)
...
<!-- <p>https://wiki.corp.adobe.com/display/omtrcache/Visitor+API+Release+Log</p> --> Version 1.5.7 includes the following features and fixes.
...
**Fixes** 
The visitor API no longer forces an extra re-synchronization call with ` Audience Manager` when there is no legacy Analytics visitor ID. (AN-121403) 
See [ Marketing Cloud ID Service ](https://marketing.adobe.com/resources/help/en_US/mcvid/) product documentation. 
[ Top ](06162016.md#concept_3DD490B0F7DD4157BD55519762B53B0C) 

* [ Important Notices about Analytics ](06162016.md#analytics_notices)
* [ New Features in Analytics ](06162016.md#features_analytics)
* [ Analytics Fixes ](06162016.md#analyticsfixes)
...
* Fixed an issue where deleted users remain listed as * ` authorizers` * for specific properties in ` Social`. (AS-37219)
...
* Fixed an issue where downloaded ` Moderation Overview` reports of specific date ranges were missing certain sections. (AS-34917)
[ Top ](06162016.md#concept_3DD490B0F7DD4157BD55519762B53B0C) 
