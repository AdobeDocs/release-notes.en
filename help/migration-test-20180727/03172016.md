...
uuid: a61d707d-3bd8-4a97-94a1-d9312768b29a
index: n
internal: n
snippet: y
translate: y
...
<!-- <b>Contacts and assignments:</b> https://wiki.corp.adobe.com/display/techpubs/Release+Notes --> Release: March 2016
...
**Documentation** 
Revised ID service implementation procedures for `Analytics` customers. See [Set Up the Marketing Cloud ID Service with Analytics](https://marketing.adobe.com/resources/help/en_US/mcvid/?f=mcvid-setup-analytics.html). 
March 17, 2016

* [Important Notices about Analytics](03172016.md#analytics_notices)
* [Analytics Fixes](03172016.md#analyticsfixes)
...
<!-- <p> <b>Known Issues</b> </p> --> [Top](03172016.md#marketingcloud) 
**New Features** 
...
* Fixed an issue that prevented the `1_documents.xlsx` file from being included in the zip file after exporting data from the `Social Buzz` report.
