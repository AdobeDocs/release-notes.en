...
<!-- <p><b>Instructions:</b> This file is the template for the monthly RNs. To update links, open this file in notepad++, search for <span class="filepath">00_template</span> and replace all occurrences with the current file name, usually release date. When adding content, edit only the tables and Fixes ULs. Do not overwrite Concepts, Sections, or the topic maps ULs. </p> -->
 <!-- <b>Contacts and assignments:</b> https://wiki.corp.adobe.com/display/techpubs/Release+Notes --> Month 2016
...
<!-- <p>https://wiki.corp.adobe.com/display/MCID/Visitor+API+Release+Log</p> --> Improvements and fixes for the Marketing Cloud ID service.
...
[Top](00_template.md#marketingcloud) 
<!-- <p>Rick, please update monthly from latest release note file and Gilles edits.</p> --> **Service Packs** 
