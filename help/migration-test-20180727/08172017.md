...
uuid: 0c7953be-10f4-443d-ac38-b15d131df853
index: n
internal: n
snippet: y
translate: y
...
<!-- <p> <b>Instructions:</b> This file is the template for the monthly RNs. To update links, open this file in notepad++, search for <span class="filepath"> 08172017 </span> and replace all occurrences with the current file name, usually release date. When adding content, edit only the tables and Fixes ULs. Do not overwrite Concepts, Sections, or the topic maps ULs. </p> -->
 <!-- <b>Contacts and assignments:</b> https://wiki.corp.adobe.com/display/techpubs/Release+Notes --> August 2017
...
* [ Enterprise Cloud Interface ](08172017.md#marketing_cloud_interface)
* [ ID Service ](08172017.md#mcvid)
* [ Mobile Services ](08172017.md#mobile)
...
<!-- <p>https://wiki.corp.adobe.com/display/MCID/Visitor+API+Release+Log</p> --> This release increments the ID service code to version 2.4.
...
* [ Analytics - New Features ](08172017.md#features_analytics)
* [ Analytics - Fixes and Updates ](08172017.md#analytics-interface)
* [ Analytics - Administration, Implementation, Developer ](08172017.md#analytics-implement)
...
* Added a new configuration ` isCoopSafe`. This is an optional, Boolean configuration that determines if DIL sends data to the ` Adobe Marketing Cloud Device Co-op`. See [ isCoopSafe ](https://marketing.adobe.com/resources/help/en_US/aam/?f=dil-coopsafe.html). (CORE-4334)
...
* [ Listening Rules ](https://marketing.adobe.com/resources/help/en_US/social/c_settings_rules.html): Rules automatically turn inactive after 6 months. Expired rules can be found in the ` Inactive` tab of the ` Rule Builder` and can be renewed for 6 months individually or in bulk.
...
* [ AEM release notes ](08172017.md#section_A26CA0B1CC014A59A59EE6406C61771C)
* [ Additional resources ](08172017.md#section_EB2C0B4AB8C542F9827D0DE582825D9E)
