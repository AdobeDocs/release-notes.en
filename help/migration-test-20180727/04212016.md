...
* [ Marketing Cloud Interface ](04212016.md#marketing_cloud_interface)
...
<!-- <p>https://wiki.corp.adobe.com/display/omtrcache/Visitor+API+Release+Log</p> --> There are no customer-facing changes in this release. The version (v1.4.5) remains the same.
...
<!-- <p> <b>Known Issues</b> </p> --> [ Top ](04212016.md#marketingcloud) 
...
</ul> --> [ Top ](04212016.md#marketingcloud) 
...
[ Top ](04212016.md#marketingcloud) 
<!-- <p>Rick, please update monthly from latest release note file and Gilles edits.</p> --> Adobe recommends customers with on-premise deployments to deploy the latest recommended patches to ensure higher stability, security, and performance.
