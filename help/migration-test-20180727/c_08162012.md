...
* Fixed an issue that prevented the `Key Metrics Report` from showing Page Views when a single day was selected.
...
* Removed the `DREAMmail` e-mail eVar from the interface.
