...
uuid: f951d8e0-0bac-40ff-b137-94d4834546e6
index: n
internal: n
snippet: y
translate: y
...
* [ Marketing Cloud Interface ](05212015.md#marketing_cloud_interface)
* [ Mobile Services ](05212015.md#mobile)
* [ Dynamic Tag Management ](05212015.md#dtm)

## Marketing Cloud 15.5.1 {#marketing_cloud_interface}
...
* Resolved issue for some IMS users redirecting from ` marketing.adobe.com` not seeing any apps in ` mobilemarketing.adobe.com`.
* Added custom calendar support in Retention for 4-5-4 and 4-4-5 (custom and retail).
New features and fixes in the ` Adobe Mobile Services` SDKs. 
...
* [ New Features in Analytics ](05212015.md#features_analytics)
* Fixes: 
    * [ Reports &amp; Analytics ](05212015.md#fixes_reports_analytics)
    * [ Data Warehouse ](05212015.md#fixes_data_warehouse)

* [ AppMeasurement and Mobile SDKs ](05212015.md#appmeasurement_sdk)
...
|  Feature  | Description  |
|---|---|
|  [ Audience Marketplace ](https://marketing.adobe.com/resources/help/en_US/aam/c_audience_marketplace.html)  | ` Audience Marketplace` provides specialized features that lets data buyers and data providers execute data deals in a self-service manner with minimum effort. Talk to your ` Audience Manager` consultant to get started. They can activate ` Audience Marketplace` for you.  |
...
* [ Understanding Wild Card Permissions ](https://marketing.adobe.com/resources/help/en_US/aam/c_wildcard_permissions.html): Use ` Wild Card Permissions` to give group members access to new data sources automatically. With standard permissions, you must manually assign new data sources to a group.
**Known Issues** 
