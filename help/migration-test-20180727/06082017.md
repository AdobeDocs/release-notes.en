...
uuid: f5dcb06f-810c-4536-9aba-0b400f245aca
index: n
internal: n
snippet: y
translate: y
...
* [ Experience Manager ](06082017.md#experiencemanager) (Includes [ Livefyre ](06082017.md#livefyre))
...
* [ Experience Cloud Interface ](06082017.md#marketing_cloud_interface)
* [ ID Service ](06082017.md#mcvid)
* [ Mobile Services ](06082017.md#mobile)
...
* For iOS 10.3, an issue where Marketing Links displays a blank page after the user clicks ** ` Cancel` ** has been fixed. (MOB-7380)
* The global filter was removed for the apps overview page. (MOB-1705)
See [ Adobe Mobile Services ](https://marketing.adobe.com/resources/help/en_US/mobile/) for product documentation. To see the release notes for previous releases, expand *Previous Release Notes* in the left pane. 
[ Top ](06082017.md#recipes) 
Release date: **June 8, 2017**

* [ Analytics - New Features ](06082017.md#features_analytics)
* [ Analytics - Fixes and Updates ](06082017.md#analytics-interface)
* [ Analytics - Administration, Implementation, Developer ](06082017.md#analytics-implement)
...
* [ Understanding Calls to the Demdex Domain ](https://marketing.adobe.com/resources/help/en_US/aam/demdex-calls.html) provides an explanation about why ` Audience Manager` makes calls to this domain.
* [ Outbound Hadoop Sequence Files ](https://marketing.adobe.com/resources/help/en_US/aam/outbound-seq-files.html) describes how you can export data from ` Audience Manager` into Hadoop using binary sequence files.
* [ Profile Merge Rules FAQ ](https://marketing.adobe.com/resources/help/en_US/aam/profile-merge-faq.html) provides answers to some common ` Profile Merge Rules` and device graph questions.
...
* Fixed an issue with targeting by city when creating ` Facebook` audiences.
* Fixed an issue with ` LinkedIn` publishing where a post with a link would publish without the link attachment or its corresponding image.
* Added a warning in ` Publisher` that the post preview is an approximation and may not match mobile delivery.
[ Top ](06082017.md#recipes) 
