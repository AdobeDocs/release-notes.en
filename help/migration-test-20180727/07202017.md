...
<!-- <p>https://wiki.corp.adobe.com/display/MCID/Visitor+API+Release+Log</p> --> This release increments the ID service code to version 2.3. It includes the following features, fixes, and other changes.
...
<!-- <p> <b>Known Issues</b> </p> --> [ Top ](07202017.md#recipes) 
Release date: **July 20, 2017**
