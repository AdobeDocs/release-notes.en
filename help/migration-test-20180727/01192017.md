...
<!-- <p>https://wiki.corp.adobe.com/display/MCID/Visitor+API+Release+Log</p> --> This release increments the ` Marketing Cloud` ID service code ( ` VisitorAPI.js`) to version 2.0. It includes the following features, fixes, and other changes. 
