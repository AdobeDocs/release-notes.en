...
<!-- <p> <b>Instructions:</b> This file is the template for the monthly RNs. To update all links, open this file in notepad++, search for <span class="filepath">11122015</span> and replace all occurrences with the current file name (usually release date). When adding content, edit only the tables and Fixes ULs. Do not overwrite Concepts, Sections, or the topic maps ULs. </p> -->
 <!-- <b>Contacts and assignments:</b> https://wiki.corp.adobe.com/display/techpubs/Release+Notes --> Updated November 5, 2015
<!-- <p> 
 <note type="important">
...
<!-- <p>https://wiki.corp.adobe.com/display/omtrcache/Visitor+API+Release+Log</p> --> Improvements and fixes for the Marketing Cloud ID service (v1.5.3).
