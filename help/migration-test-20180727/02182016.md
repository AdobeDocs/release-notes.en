...
description: Experience Cloud updates plus, general fixes and improvements for the February maintenance release.
keywords: release notes
seo-description: Experience Cloud updates plus, general fixes and improvements for the February maintenance release.
...
<!-- <p> <b>Instructions:</b> This file is the template for the monthly RNs. To update links, open this file in notepad++, search for <span class="filepath"> 02182016 </span> and replace all occurrences with the current file name, usually release date. When adding content, edit only the tables and Fixes ULs. Do not overwrite Concepts, Sections, or the topic maps ULs. </p> -->
 <!-- <b>Contacts and assignments:</b> https://wiki.corp.adobe.com/display/techpubs/Release+Notes --> February 2016
