...
uuid: c7b662f1-efe1-4e1c-976f-bd8cb128b0a6
index: n
internal: n
snippet: y
translate: y
...
<!-- <p> 
 ...
 </note> </p> --> Release month: **November 2016**
...
* [ Marketing Cloud Interface ](11102016.md#marketing_cloud_interface)
* [ Marketing Cloud ID Service ](11102016.md#mcvid)
* [ Mobile Services ](11102016.md#mobile)
...
<!-- <p>https://wiki.corp.adobe.com/display/omtrcache/Visitor+API+Release+Log</p> --> Release date: **November 10, 2016**
...
* Added ` Visitor.overwriteCrossDomainMCIDAndAID`, a boolean function that lets you overwrite the ` Marketing Cloud` and ` Analytics` IDs on other domains that you own. (MCID-218)
...
* Added ` idSyncByURL` and ` idSyncByDataSource`, 2 functions that let you manually implement an ID sync in the ` Destination Publishing iFrame`. (MCID-166)
...
* [ Important Notices for Analytic Administrators ](11102016.md#analytics_notices) Updated **November 29, 2016**
* [ New Features in Analytics ](11102016.md#features_analytics)
* [ Analytics Fixes ](11102016.md#analyticsfixes)
