...
* [ Marketing Cloud and Core Services ](05192016.md#marketingcloud) (Updated May 26)
* [ Analytics ](05192016.md#analytics)
* [ Audience Manager ](05192016.md#aam)
* [ Social ](05192016.md#social)
* [ Target ](05192016.md#target)
* [ Campaign ](05192016.md#campaign)
* [ Experience Manager ](05192016.md#experiencemanager)
* [ Media Optimizer ](05192016.md#mediaoptimizer)
* [ Recent Documentation Updates ](05192016.md#docupdates)

* [ Marketing Cloud Interface ](05192016.md#marketingcloud/marketing_cloud_interface)
* [ Mobile Services ](05192016.md#marketingcloud/mobile)
* [ Marketing Cloud ID Service ](05192016.md#marketingcloud/mcvid)
## Marketing Cloud
      16.5.1 {#marketing_cloud_interface}
...
[ Top ](05192016.md#marketingcloud)
...
>[!NOTE]
>
>Accessing`keyword  Target` functionality within `keyword  Mobile Services` now requires that users be logged in with an Adobe ID that is provisioned for their `keyword  Target` company. Logging in with a `keyword  Target` username and password has been removed.
...
**Enhancements**
  ...
  *
  Added `wintitle  Impressions` / `wintitle  Engagement Rate` for in-app messaging reporting. Requires version 4.9.0 of the Android or iOS SDK.
...
* [ Important Notices about Analytics ](05192016.md#analytics/analytics_notices)
* [ New Features in Analytics ](05192016.md#analytics/features_analytics)
* [ Analytics Fixes ](05192016.md#analytics/analyticsfixes)
 ...
 <tgroup cols="3"> 
  ...
  <tbody> 
   ...
   <tr> 
    ...
    <td colname="col02"> <p>February 18, 2016 </p> </td> 
    <td colname="col2"> <p>Adobe's geo service provider is changing how we receive UK postal codes. We will be switching from providing truncated UK postal codes to full postal codes on or around March 18th. 
      <!--Perpetuate this for a few months.--></p> </td> 
   </tr> 
   <tr> 
   ...
   <tr> 
    ...
    <td colname="col2"> 
     ...
     <ul id="ul_F303CB7334E04F3B9489EB7C0F778A3E"> 
      <li id="li_99AC87DB34984CC9BAC77AC5C3671B72">Inclusion of Visitor API 1.5.6 (latest <a href="05192016.xml#marketingcloud/mcvid" format="dita" scope="local"> Marketing Cloud ID service </a>) </li> 
     ...
     </ul> <p> <b>JavaScript H code (Legacy)</b> </p> <p>Inclusion of Visitor API 1.5.5 (latest <a href="05192016.xml#marketingcloud/mcvid" format="dita" scope="local"> Marketing Cloud ID service </a>) </p> <p> <b>Flash 4.0.1 - Update</b> </p> <p>Inclusion of Visitor API 1.5.6 </p> </td> 
   </tr> 
   <tr> 
...
* Fixed an issue that caused a "reply failed" message to display in `wintitle  Moderation` when replying to a LinkedIn post.
* Fixed an issue that caused inconsistent data between the `wintitle  Moderation Overview` report and its downloaded report.
* Fixed an issue in `wintitle  Publish Anywhere` in which `keyword  Adobe Social` did not recognize a custom branded domain. This fix is for `wintitle  Publish Anywhere` and not for `wintitle  Publisher` and `wintitle  Content Calender`.
