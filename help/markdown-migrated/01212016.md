...
* [ New Features in Analytics ](01212016.md#analytics/features_analytics)
...
* Fixed an issue with the exported `wintitle  Moderation Overview` report that caused tag IDs to display instead of tag names. (AS-35454)
