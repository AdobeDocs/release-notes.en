---
title: Central Release Notes - November 2022
...
>[!IMPORTANT]
>
>Check back frequently to stay on top of what's happening on Experience League. The next Priority Product Update will deploy in **January 2023**, after the holiday season. Stay tuned!
...
* Provides advanced personalization and segmentation, thanks to the [insertion of Campaign variables](https://github.com/adobe/aem-core-email-components/wiki/RTE-Personalization) on most dialog fields, and to the flexible [Segmentation component](https://github.com/adobe/aem-core-email-components/wiki/).
...
|November 2022|[Register and sign using D-Trust](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/digital-id/dtrust/d-trust.html)|Video |Learn how to register your identity with D-Trust, and then use the D-Trust digital signature on a document.|Acrobat Sign |
