 ...
 <tgroup cols="2"> 
  ...
  <tbody> 
   ...
   <tr> 
    ...
    <td colname="col2">Cloned traits or segments are now automatically assigned to the same storage folder as the original trait or segment. However, you can select a different folder if required.</td> 
   </tr> 
  </tbody> 
 </tgroup> 
</table>
