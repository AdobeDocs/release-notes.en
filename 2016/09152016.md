...
* [ Marketing Cloud and Core Services ](09152016.md#marketingcloud)
* [ Analytics ](09152016.md#analytics)
* [ Audience Manager ](09152016.md#aam)
* [ Social ](09152016.md#social)
* [ Target ](09152016.md#target)
* [ Primetime ](09152016.md#primetime)
* [ Campaign ](09152016.md#campaign)
* [ Experience Manager ](09152016.md#experiencemanager)
* [ Media Optimizer ](09152016.md#mediaoptimizer)
* [ Recent Documentation Updates ](09152016.md#docupdates)
* [ Marketing Cloud Interface ](09152016.md#marketingcloud/marketing_cloud_interface)
* [ Marketing Cloud ID Service ](09152016.md#marketingcloud/mcvid)
* [ Mobile Services ](09152016.md#marketingcloud/mobile)
## Marketing Cloud
      16.8.1 {#marketing_cloud_interface}

New features and fixes in the `keyword  Adobe Marketing Cloud` interface and core services.
...
[ Top ](09152016.md#marketingcloud)
...
Added `codeph  disableThirdPartyCalls` as an optional, Boolean flag you can set in the `codeph  Visitor.getInstance` function. When `codeph  disableThirdPartyCalls= true`, the ID service will not make calls to other domains. By default, `codeph  disableThirdPartyCalls= false`. See [ disableThirdPartyCalls ](https://marketing.adobe.com/resources/help/en_US/mcvid/?f=mcvid-disablethirdpartycalls.html). (MCID-51)
...
* [ Important Notices for Analytic Administrators ](09152016.md#analytics/analytics_notices)
* [ New Features in Analytics ](09152016.md#analytics/features_analytics)
* [ Analytics Fixes ](09152016.md#analytics/analyticsfixes)
  ...
  <tbody> 
   ...
   <tr> 
    ...
    <td colname="col2"> 
     <draft-comment> 
     ...
     </draft-comment> <p> <b> <span class="keyword"> AppMeasurement </span> for JavaScript</b> </p> <p>Version <b>1.7.0</b></p> <p> 
      <ul id="ul_3F8A5E32DCAE4339A06A737F820894DC"> 
       ...
       <li id="li_66D2B0EB7C5E4B05A09C02D5A0B49F99">Inclusion of <a href="09152016.xml#marketingcloud/mcvid" format="dita" scope="local"> Visitor API 1.8.0 </a> (AN-129887) </li> 
     ...
     </draft-comment> <p> <b>See Also:</b> <a href="09152016.xml#marketingcloud/mcvid" format="dita" scope="local"> Marketing Cloud ID Service </a> (formerly <span class="term"> visitor ID service </span>) </p> </td> 
   </tr> 
   <tr> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 <tgroup cols="2"> 
  <colspec colnum="1" colname="col1" colwidth="1.00*" /> 
  <colspec colnum="2" colname="col2" colwidth="1.64*" /> 
  <thead> 
   <tr> 
    <th colname="col1" class="entry"> Feature </th> 
    <th colname="col2" class="entry"> Description </th> 
...
* Fixed an issue where the Help Modal was not working on the `wintitle  Profile Merge Rules` page. (AAM-25712)
* Fixed an issue in `wintitle  Audience Lab` where no warning would appear that you have not mapped all selected destinations when navigating to "Finalize" step. (AAM-25877)
* Fixed an issue in `wintitle  Audience Lab` where "Invalid date" would show on the Test Group Information page when no end date was specified on the `wintitle  Destination Mappings` page. (AAM-26016)
* Fixed an issue in `wintitle  Audience Lab` where, in the edit baseline segment modal, [object Object] would appear instead of the baseline segment creator. (AAM-26057)
* Fixed an issue where for `wintitle  Audience Lab` and `wintitle  Profile Merge`, "Adobe Audience Manager | undefined" would appear in the browser tab title. (AAM-26091)
* Fixed an issue in the Create Test Groups flow in `wintitle  Audience Lab` where no warning message would appear in case you left any destinations unmapped. (AAM-26109)
* Fixed an issue when you tried to edit `wintitle  Destinations`, an alert box would appear and the Destination could not be edited. (AAM-26191)

**Improvements**


* Removed the "OK_With_Unused_Signals" error from the error list in the Onboarding Status Report. (AAM-25240)
* In `wintitle  Audience Lab`, we now remind you to download the CSVs before deleting any Segment Test Groups. (AAM-25581)
...
<!-- <ul id="ul_05D01271A95C450691D85FE5B81B5E4A"> 
 <li id="li_C12B8E410C6F4C46AD55179A52DA66FC"></li> 
 <li id="li_CA845C4244544315AE740497AB83DFD7"></li> 
</ul> -->
[ Top ](09152016.md#marketingcloud)

**Fixes, Enhancements, and Deprecations**

* `wintitle  Publish Anywhere` has replaced `wintitle  Publisher`. [ Get familiar with the improved features. ](https://marketing-resource-help.s3.amazonaws.com/resources/help/en_US/social/Publisher%20Update.pdf)
...
* A post retweeted from within `keyword  Adobe Social` now appears the same as when it is retweeted natively in Twitter.  For more information, see [ Moderate an Individual Tweet ](https://marketing.adobe.com/resources/help/en_US/social/t_mod_individual_tweet.html) and [ Post a Quoted Tweet ](https://marketing.adobe.com/resources/help/en_US/social/t_post-quoted-retweet.html).
* Social tags will be available in Adobe Analytics after October 1 (exact date TBD).
    * After October 1, `keyword  Adobe Social` users will be able to use [ social tags ](https://marketing.adobe.com/resources/help/en_US/social/c_settings_tag_manr.html) to classify outbound content and report on this content within `keyword  Adobe Analytics`. To get on this list for access to this new feature, please contact your `keyword  Adobe Social` account manager or Social Support. From there you will receive updates on next steps regarding gaining access as well as enablement assistance.
  
* Fixed an issue within `wintitle  Post Analytics` where the filter was unable to distinguish between images and links posted on LinkedIn.
...
<table id="table_5AB641198DF34491AE6D411A9BA32B51"> 
 <tgroup cols="3"> 
  <colspec colnum="1" colname="col1" colwidth="1.00*" /> 
  <colspec colnum="2" colname="col2" colwidth="1.30*" /> 
  <colspec colnum="3" colname="col3" colwidth="2.41*" /> 
  <thead> 
   <tr> 
  ...
  <tbody> 
   ...
   <tr> 
    ...
    <td colname="col3"> <p>Join peers in your area or, if you are traveling, join a user group meeting. Adobe Systems lists each of the events on the community calendar <a href="https://communities.adobe.com/en/communities/aem_technologistsdevelopersarchitects/events.html" format="https" scope="external"> here </a>. </p> <p>The Seattle User Group has two upcoming meetings. See details at <a href="https://www.meetup.com/Seattle-Adobe-CQ-AEM-Meetup-Group/" format="https" scope="external"> https://www.meetup.com/Seattle-Adobe-CQ-AEM-Meetup-Group/ </a>. </p> <p>The <a href="http://www.meetup.com/Melbourne-AEM-CQ-Meetup/" format="http" scope="external"> Melbourne Adobe Experience Manager Meetup </a> group is hosting a code contest. The deadline to register your teams for presenting at the Adobe Marketing Cloud - Community Expo (AMCCE) is September 30, 2016. You can register at the following: <a href="https://www.surveymonkey.com/r/R596336" format="https" scope="external"> https://www.surveymonkey.com/r/R596336 </a>. </p> <p>The next meeting for the Amsterdam, Netherlands AEM User Group is November 3, 2016. You can RSVP <a href="http://www.meetup.com/AEM-Developer-Meetup/events/233761022/?rv=ea1&amp;_af=event&amp;_af_eid=233761022&amp;https=off" format="http" scope="external"> here </a>. </p> </td> 
   </tr> 
   <tr> 
    ...
    <td colname="col3"> <p>The recorded August webinar titled, "AEM and eCommerce" is available to watch at the following:</p> 
     <ul id="ul_508FC7C27B8F471F9A7F385CCD77078D"> 
      <li id="li_2B1A318AA2F448B7B6419C282FA9ECB8">Adobe Connect version - <a href="http://adobe.ly/2bHWkgF" format="http" scope="external"> http://adobe.ly/2bHWkgF </a>. </li> 
      <li id="li_7AE78F4B2D6A4AFBB5CB3C3924AF1ABC">MP4 version - <a href="http://adobe.ly/2bHWmF9" format="http" scope="external"> http://adobe.ly/2bHWmF9 </a>. </li> 
   ...
   <tr> 
    ...
    <td colname="col3"> <p>The last recorded GEM webinar titled "Setup and Configure AEM Dynamic Media" is available to watch at the following:</p> 
     <ul id="ul_2920B3F5D5494CED86BC312ACB4FD40D"> 
      <li id="li_D5638F1BA76C4B1BAADFEC17ABB637DA">Connect version - <a href="http://adobe.ly/2b1T5WG" format="http" scope="external"> http://adobe.ly/2b1T5WG </a>. </li> 
      <li id="li_1F8D8B574E53468BADE373C50896AC7C">MP4 version - <a href="http://adobe.ly/2b1SODb" format="http" scope="external"> http://adobe.ly/2b1SODb </a>. </li> 
   ...
   <tr> 
    ...
    <td colname="col3"> <p>AEM Developer Community event hosted by Pro!Vision, September 26-28 in Berlin.</p> <p>Tickets are available at the following: <a href="http://adapt.to/2016/en.html"> http://adapt.to/2016/en.html </a>. </p> </td> 
   </tr> 
   <tr> 
