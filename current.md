...
|Published|Name|Type|Description |
| -----------| ---------- | ---------- | ---------- |
|October 2021|[What is a digital signature?](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/digital-id/digitalid-overview.html)|Video |Learn how to use digital IDs from around the world with Adobe Sign.|
