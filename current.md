...
|May 2025|[AEP doesn't support restricting API access based on specific IP addresses](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-26471)|New article| Learn about the solutions to the issue where you can't restrict API access to specific IP addresses within Adobe Experience Platform (AEP).|
...
|May 2025|[Too many `Contains` operators cause segments working incorrectly](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-25262)|New article| Learn about the solutions to the issue when too many `Contains` operators cause segments to work incorrectly.|
...
|May 2025|[[!DNL Cron] and index issues in Adobe Commerce on Cloud infrastructure](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-26409)|New articles| Learn about the solutions to the issue when recurring problems with automatic indexing via [!DNL cron] disrupt store operations.|
...
|May 2025|[Workflow running unexpectedly despite scheduler settings on Adobe Campaign Managed Cloud](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-26415)|New article| Learn about the solutions to the issue when scheduler updates aren't applied and unexpected workflow executions occur in Adobe Campaign Managed Cloud.|
...
|May 2025|[Recipient count drops after delivery activity in Adobe Campaign Classic](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-26446)|New article| Learn about the solutions to the issue when the record count drops after a delivery activity.|
