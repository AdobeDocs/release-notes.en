...
|October 2025|[Performance related Q&A with Dynamic Media with Open APIs](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27825)|New article| Learn about the solutions to the issue when DMwOA images are served with a longer than expected delay time.|
|October 2025|[Issue on DM with OpenAPI - Video Player Container API](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27804)|New article| Learn about the solutions to the issue when using DynamicMedia with open APIs function, and use the code returned to display the viewer from an external website unaltered, the code generates malformed URLs to fetch video details and won't work as expected.|
