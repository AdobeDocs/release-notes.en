...
|Published|Name|Type|Description|
|---------|--------|---------|---------|
|October 2025|[Adobe Experience Manager: CDN Configuration isn't updated after changing Cloud Manager environment variables](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27861)|New article| Learn about the solutions to the issue when modifying environment variable values in Cloud Manager doesn't automatically update the CDN configuration.|
|October 2025|[Adobe Experience Manager: How to Handle the "Query Without Index Detected" Alert](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27862)|New article| Learn about the solutions to the issue in AEMaaCS when an alert email with the subject line "Query Without Index Detected" occurs.|
|October 2025|[AEM integration with Workfront returns error due to missing proxy configuration suffix](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27728)|New article| Learn about the solutions to the issue when the Adobe Experience Manager (AEM) integration with Workfront using the [!UICONTROL Enhanced Connector] for the first time fails with an error.|
|October 2025|[File uploads fail for filenames with special characters in AEM Forms](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27475)|New article| Learn about the solutions to the issue when file uploads through [!UICONTROL Adaptive Forms] in AEM Forms on-premises 6.5 fail when filenames contain special or Unicode characters.|
|October 2025|[DAM Update Asset Workflow generates oversized sub-assets from large PDF files](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27744)|New article| Learn about the solutions to the issue when using Adobe Experience Manager (AEM) 6.5 Managed Services, uploading large multi-page PDFs lead to unexpected repository growth.|
|October 2025|[DM Open API background-color parameter isn't working as expected](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27896)|New article| Learn about the solutions to the issue when the DMwOA implementation has a background-color parameter, but it doesn't work as expected.|
|October 2025|[Performance related Q&A with Dynamic Media with Open APIs](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27825)|New article| Learn about the solutions to the issue when DMwOA images served with a longer than expected delay time.|
|October 2025|[Issue on DM with OpenAPI - Video Player Container API](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27804)|New article| Learn about the solutions to the issue when When using the DynamicMedia with open APIs function, and use the code returned to display the viewer from an external website unaltered, the code generates malformed URLs to fetch video details and won't work as expected.|
|October 2025|[401 error when using local dev token in AEM Forms as a Cloud Service](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27706)|New article| Learn about the solutions to the issue when using a local development token from Adobe Developer Console (ADC) in AEM Forms as a Cloud Service, a 401 error occurs.|
|October 2025|[**[!UICONTROL Request for Deletion]** workflow isn't working in AEM Sites](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27558)|New article| Learn about the solutions to the issue in AEM Sites when you delete content pages without the **[!UICONTROL Replicate]** permission, the system triggers the **[!UICONTROL Request for Deletion]** workflow.|
|October 2025|[AEMaaCS: Mobile devices show two play buttons in Dynamic Media videos](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27477)|New article| Learn about the solutions to the issue when Dynamic Media videos in Adobe Experience Manager (AEM) as a Cloud Service show two overlapping play buttons when viewed on mobile devices.|
|October 2025|[New Relic dashboard shows only AMS virtual machines (VMs) instead of AEMaaCS VMs in AEMaaCS](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27864)|New article| Learn about the solutions to the issue in AEMaaCS when the New Relic dashboard shows only AMS virtual machines (VMs) instead of AEMaaCS VMs.|
|October 2025|[Querybuilder API bypasses dispatcher filters and exposes sensitive information](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27832)|New article| Learn about the solutions to the issue when an access control issue in Adobe Experience Manager as a Cloud Service (AEMaaCS) where the Querybuilder API can bypass dispatcher filters, potentially exposing sensitive information.|
|October 2025|[Media rewrites impact on SEO rankings in EDS websites](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27810)|New article| Learn about the solutions to the issue in AEMaaCS - Sites when Edge Delivery Services rewrite media asset paths to optimize delivery and caching.|
|October 2025|[Tag filter fails in [!UICONTROL Micro Frontend Asset Selector] with AEM delivery tier integration](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27585)|New article| Learn about the solutions to the issue in AEMaaCS - Assets when using the [!UICONTROL Micro Frontend Asset Selector] integrated with a third-party authoring application, the tag filter doesn't work as expected.|
|October 2025|[Clarifying vulnerability assessment scheduling in AEMaaCS](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27807)|New article| Learn about vulnerability assessment scheduling in AEMaaCS - Sites.|
...
|Published|Name|Type|Description|
|---------|--------|---------|---------|
|October 2025|[[!DNL Quality Patches Tool] (QPT)](https://experienceleague.adobe.com/en/docs/commerce-operations/tools/quality-patches-tool/patches-available-in-qpt/patches-available-in-qpt-tool-overview)|New articles| New articles on how to apply patches available in QPT 1.1.71, QPT 1.1.72, and QPT 1.1.73 were published and can be found in their respective sections.|
|October 2025|[Deployment not triggering after code push in Adobe Commerce on cloud infrastructure](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27858)|New articles| Learn about the solutions to the issue when code pushes to the Staging or Production branches via the [!DNL GitHub] or [!DNL Bitbucket] integration aren't triggering deployments in Adobe Commerce on cloud infrastructure as expected.|
|October 2025|[[!DNL Apple Pay] domain verification fails due to read-only root directory in Adobe Commerce](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27609)|New articles| Learn about the solutions to the issue in Adobe Commerce on Managed Services, when [!DNL Apple Pay] domain verification fails because the root-level `.well-known` directory is restricted and not writable.|
|October 2025|[Changes in the database aren't reflected on the storefront](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27805)|New articles| Learn about the solutions to the issue when delays or interruptions occur in entity updates being applied.|
|October 2025|[[!DNL MySQL] disk space is low on Adobe Commerce on cloud infrastructure](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27806)|New articles| Learn about the solutions to the issue when very low space or no space occurs in your [!DNL MySQL] database on Adobe Commerce on cloud infrastructure.|
|October 2025|[Error 404 on all pages due to Content Staging issue](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27785)|New articles| Learn about the solutions to the issue in Adobe Commerce on-premises and Adobe Commerce on cloud infrastructure where you get a 404 error when accessing any storefront page or the Commerce [!UICONTROL Admin].|
...
|Published|Name|Type|Description|
|---------|----|----|-----------|
|October 2025|[Email truncation with "`&`" when tracking is enabled in Adobe Campaign Standard](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27837)|New article| Learn about the solutions to the issue in ACS when tracking is enabled, email content left of the "`&`" symbol disappears.|
|October 2025|[Campaign: multibranding in multi-cell [!UICONTROL Message Center] setup](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27800)|New article| Learn about the solutions to the issue when using the same transactional email template, URLs in the email content don't show the exact same subdomain for different recipients, and learn how to configure multibranding for clients using multiple [!UICONTROL Message Center] instances.|
