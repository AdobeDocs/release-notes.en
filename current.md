...
|Analytics Dashboards support for Custom Date Ranges |March 25, 2021 |Scorecard creators can create and apply custom date ranges to mobile scorecard projects. Creators can choose from familiar workspace and mobile date range pre-sets or create a custom date range. This feature will begin rolling out March 25th. |
