...
|Workspace: Download 50K items for a single dimension|Sept. 17, 2020|[Early announcement] You will be able to download 50,000 items for a single dimension in a freeform table, with segments and filters applied. This allows you to access more than the 400 rows of data outside of Analysis Workspace.|
