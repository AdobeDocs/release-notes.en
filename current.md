...
|September 2025|[Video Preview issue on AEM 6.5 + DMS7](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27496)|New article| Learn about the solutions to the issue when an AEM 6.5 Author is setup to replicate to DMS7, but assets can't be previewed using the DMS7 viewers.|
...
|September 2025|[Configuring a custom domain for Dynamic Media asset delivery in AEM Cloud](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27330)|New article| Learn about how to configure a custom domain for Dynamic Media delivery in Adobe AEM Cloud.|
...
|September 2025|[Action Required: Critical Security Update Available for Adobe Commerce  (APSB25-88)](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27397)|New articles| Learn about the hotfix patch to address to remediate the vulnerability CVE-2025-54236 in Adobe Commerce.|
