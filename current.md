...
* **[!DNL EXPERIENCE CLOUD]** | Webinar | _The Perfect Blend: Marketo + Workfront_ | **August 31 @ 1:00 PM ET** | [Register](https://attendee.gotowebinar.com/register/1243658035029822043?source=ExL)

* **[!DNL WORKFRONT]** | Community event | _Adobe Workfront Connect: Admin Chat for Marketing & Creative_ | **September 1 @ 10:00 AM MT** | [Register](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,1qnTSsu1BE6bJ4ijFsYafg,COdPeWL3z0qsME9nhjnRwg,KBvGRYIBNkS8UYZoXhEzyg,NxN8MJvklk2hHdVSkoIQlQ,IOANuFGpiEehM82GeIib2g?mode=read&tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1)

* **[!DNL MARKETO ENGAGE]** | Community event | _Boost Email Deliverability with [!DNL Marketo Engage]_ | **September 7 @ 8:00 AM PT** | [Register](https://engage.marketo.com/Boost_Email_Deliverability.html?utm_source=exl)

* **GENERAL** | Livestream | _App Builder Live - Migrating to OAuth_ | **September 7 @ 9:00 AM PT** | [Register](https://www.eventbrite.com/e/app-builder-live-migrating-to-oauth-tickets-687485968037?aff=explg)

* **[!DNL WORKFRONT]** | Customer workshop | _Learn: Making the Case for a Full-Time Sys Admin_ | **September 7 @ 12:00 PM CT** | [Register](https://engage.marketo.com/Boost_Email_Deliverability.html?utm_source=exl)
...
| August 2023 |[[!DNL Adobe Experience Manager Forms]: How to change [!DNL JBoss] log path?](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22689.html)|New article| Learn how to change the [!DNL JBoss] log path on [!DNL AEM Forms] in a [!DNL Windows Server] environment.|
...
| Published | Name | Type | Description |
| -----------| ---------- | ---------- | ---------- |
|September 2023|[Store Fulfillment Overview](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/orders/store-fulfillment.html)|Video |Learn about Store Fulfillment for Adobe Commerce by Walmart Commerce Technologies, an advanced omnichannel fulfillment solution that delivers an end to end Buy Online, Pick up In-Store (BOPIS) experience.|
|September 2023|[Sales Representative initiates the quote](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/b2b/b2b-quote/sales-rep-initiates-quote.html)|Video |Learn how the sales representative can initiate the quote from the admin panel, filter by user and website, draft quotes, quote visibility and many more features.|
|September 2023|[Use Product Attributes with PWA Studio](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/catalog/product-attributes-pwa.html)|Video |Learn how to manage product attributes when you have a storefront built with PWA Studio.|
...
|September 2023|[B2B Sales quote line item discount using GraphQL](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/b2b/b2b-quote/quote-graphql-line-item-discount.html?lang=en)|Video |Learn how to use the line item discount and see the values using GraphQL|
|September 2023|[B2B sales quote validation using the admin panel](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/b2b/b2b-quote/quote-validation-admin-panel.html)|Video |Learn the validation steps and areas that Adobe Commerce B2B Quote functionality provides to ensure the consistent and valid quote process.|
...
|September 2023|[Set Up Product Recommendations](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/marketing/product-recommendations.html)|Video |Learn how to use product recommendations on your Adobe Commerce store.|
|September 2023|[Introduction to Live Search](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/marketing/live-search.html)|Video |Learn how to add Live Search to your store and produce highly engaging, relevant, and personalized shopping experiences.|
...
|September 2023|[Sales Representative initiates the quote with the REST API](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/b2b/b2b-quote/sales-rep-initiates-quote-api.html)|Video |Learn how the sales representative can initiate the quote from the Adobe Commerce REST API.|
|September 2023|[B2B Sales quote line item notes using REST API](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/b2b/b2b-quote/quote-rest-api-line-item-notes.html)|Video |Learn how to use the line item notes for an Adobe Commerce B2B quote through the REST API.|
|September 2023|[Technical overview for App Builder](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/adobe-developer-app-builder/app-builder-technical-overview.html)|Video |Learn about Adobe Developer App Builder used in Adobe Commerce with a technical overview.|
...
| August 2023 |[Reduce expired _[!DNL oauth_tokens]_ before 2.4.6 upgrade](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/installation-and-upgrade/reduce-expired-oauth-tokens-before-2.4.6-upgrade.html)|New articles| Learn about a solution to the issue where you see a large number of *[!DNL oauth_tokens]* in your *[!DNL oauth_token]* table, which can cause a long delay in upgrading to version 2.4.6.|
...
| August 2023 |[Error sending deliveries to recipients not in database](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22570.html)|New article| Learn the workaround for when attempting to send deliveries tManual copy of database snapshoto recipients that aren't stored in the database ([!DNL DB]) via an external file, an error is thrown during delivery preparation.|
| August 2023 |[Manual copy of database snapshot](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22530.html)|New article| Learn how to create a manual copy of database snapshot.|
