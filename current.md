...
| -----------| ---------- | ---------- |
|New Adobe Analytics domain|Jan. 8, 2020|On January 16, 2020, Adobe Analytics will move to new domain - https://experience.adobe.com/analytics. This change may cause cookie issues when loading Analytics in Safari. Unchecking the "Prevent cross-site tracking" in the Safari Privacy Preferences will enable cookies across domains (and all cross-site experiences), and allow Analytics to function on this new Adobe Experience Cloud domain. Users can use other browsers without issue, since this only affects Safari users.|
