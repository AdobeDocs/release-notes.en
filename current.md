...
|January 2026|[False delay alerts for source flow runs in AEP](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29745)|New article| Learn about the solutions to the issue when alerts for sources flow run delays appear even when dataflow runs finish successfully because the alerting system's monitoring signals don't always match actual run metrics in Adobe Experience Platform.|
...
|January 2026|[Meta pixel extension loads JavaScript before consent in AEP](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29840)|New article| Learn about the solutions to the issue when the meta pixel extension in Adobe Experience Platform loads the `fbevents.js` script before consent is provided.|
...
|January 2026|[Understanding Adobe Launch (Tags) environment mapping in AEM as a Cloud Service](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28165)|New article| Learn about the solutions to the issue when configuring Adobe Launch in AEM as a Cloud Service and the configuration UI only shows Staging and Production tabs leading to confusion about which Launch library is used by each environment.|
