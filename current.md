...
|December 2025|[Adobe Experience Manager: Many index update messages reappear after upgrading to AEM 6.5 LTS SP1](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29732)|New article| Learn about the solutions to after upgrading to AEM 6.5 LTS SP1, an index log message that didn't appear previously, reappears after the upgrade.|
