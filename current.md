...
|January 2025|[[!DNL Adobe Experience Platform]: Count for failed identities seems disproportionate in relation to destination activation](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-25658)|New article| Learn how to solve the issue of the count for failed identities seems disproportionate in relation to destination activation.|
...
|Published|Name|Type|Description|
|---------|----|----|-----------|
|January 2025|[[!DNL Adobe Experience Platform]: Count for failed identities seems disproportionate in relation to destination activation](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-25603)|New article| Learn how to solve the issue of the count for failed identities seems disproportionate in relation to destination activation.|
...
|January 2025|[Tracking workflow performance issue in [!DNL Adobe Campaign Classic]](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-25628)|New article| Learn how to solve the issue of how to improve processing times for your Strategic instance's tracking workflow in [!DNL Adobe Campaign Classic].|
