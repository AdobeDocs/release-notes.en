...
| -----------|---------- | ----|
|[Adobe Analytics - Experience Makers - The Skill Exchange](https://events.bizzabo.com/389219?promo=ExperienceLeague&tr=true) |The Skill Exchange |Join us for this free, three-hour digital event focused entirely on Adobe Analytics. You will have the opportunity to ask questions live of experts and peers who know workspace best. [Details & registration](https://events.bizzabo.com/389219?promo=ExperienceLeague&tr=true)|
...
| Integration with Adobe Analytics | (April 7) In the data feed that Advertising Cloud sends to [!DNL Analytics], data for [!DNL Google Ads] and [!DNL Microsoft Advertising] dynamic search ads is available only down to the ad group level beginning on 7 May 2022.|
