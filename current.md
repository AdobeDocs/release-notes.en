...
>[!IMPORTANT]
>This page contains pre-release content and is subject to change prior to the each product's planned release.
...
* Improved product help: [!UICONTROL Experience League] is integrated into the product so that a help search also includes results from community forums and video content. This change simplifies access to more content and helps you get the most out of Experience Cloud. Additionally, click **[!UICONTROL Help]** > **[!UICONTROL Feedback]** to report issues or share your ideas with the product Adobe.  
