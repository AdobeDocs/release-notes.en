...
[Experience League Live](https://experienceleague.adobe.com/docs/experience-league-live-events/events/overview.html) is a live streaming show produced by the Experience League team. It's a chance to connect with Adobe product experts and learn actionable tips, tricks, and strategies you can apply with the Adobe Experience Cloud applications.
...
For past episodes, see [Experience League Live](https://experienceleague.adobe.com/docs/experience-league-live-events/events/overview.html).
...
|Published|Name|Type|Description |
| -----------| ---------- | ---------- | ---------- |
|November 2021|[Segment containers in Adobe Analytics](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/components/segmentation/segment-containers.html)|Video (updated) |In this video, learn how to use the containers and hear some examples of each type of container.|
|November 2021|[Sequential Segmentation in Adobe Analytics](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/components/segmentation/sequential-segmentation.html#)|Video (updated) |Learn how to build a segment in Analysis Workspace from sequences of behaviors on your site or in your application.|
|November 2021|[Before/After Sequences in Sequential Segmentation](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/components/segmentation/before-after-sequences-in-sequential-segmentation.html)|Video (updated)|Learn how to segment in Adobe Analytics so that you get only the data from before or after a specific user path.|
