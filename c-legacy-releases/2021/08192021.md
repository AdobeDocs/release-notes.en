...
* **Experience Manager as a Cloud Service**
  ...
  * **Experience Manager Forms as a Cloud Service**
    ...
    **Microsoft&reg; Azure data store connector** - You can now [connect Form Data Model to Microsoft&reg; Azure Storage](https://experienceleague.adobe.com/docs/experience-manager-forms-cloud-service/forms/use-form-data-model/configure-azure-storage.html?lang=en). It lets you retrieve and store adaptive form data to Microsoft&reg; Azure Storage as a BLOB.
