...
| -----------| ---------- | ---------- | ---------- |
|February 26, 2021 |[Monitor data flow in Adobe Experience Platform](https://experienceleague.adobe.com/docs/platform-learn/tutorials/data-ingestion/data-monitoring.html#data-ingestion) |Learn how to monitor and track data that gets ingested into Adobe Experience Platform using Platform's UI and API. |
