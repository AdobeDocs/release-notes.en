...
* **Experience Manager as a Cloud Service**
  ...
  * **Adobe Experience Manager as a Cloud Service Foundation**
    ...
    * [Experience Manager as a Cloud Service SDK Build Analyzer Maven Plugin](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/developing/archetype/build-analyzer-maven-plugin.html?lang=en): Update your maven projects to the latest version, which includes a deprecated Java&trade; API check and other improvements.
