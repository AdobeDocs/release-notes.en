  ...
  <tr> 
   ...
   <td colname="col2"> <p>A change to the (back-end) lookup mechanism is going to impact reporting in several ways. Please be aware that these changes went into effect around the <b>end of February, 2018</b>: </p> 
    <ul id="ul_7515E2E79FD94B8F8DFF4C2DBB9E6A84"> 
     ...
     <li id="li_E46207F194134AEA86F5CB2C8F26C76C"> Category reports for rollups and current data in <span class="uicontrol">Reports & Analytics</span> are no longer provided. However, deprecating category rollup reports in the Web Service API has been delayed until the April Maintenance Release </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_B3810CF9DA584DDDB811F1D0F91B78F2"> 
      ...
      <li id="li_F15E1A5F9EBB4A1AA5A7233D94051187"> <b><span class="uicontrol"> Reports & Analytics</span></b>: Fixed an issue with Target reports not correctly reporting Quarterly totals. (AN-153933) </li> 
