...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Attribution IQ lets you perform more sophisticated and intelligent analysis on marketing performance. New attribution models can be used on metrics in [!UICONTROL Analysis Workspace] (on any table or on any breakdown) and in calculated metrics. A new Attribution Panel allows for better visualization and comparison. </p> <p>Attribution IQ is available for all customers on the Ultimate, Prime, Select, and Foundation SKUs. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Added 'Last 13 full weeks' to the date range presets in [!UICONTROL Analysis Workspace]. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_E08D11345DD64677B46629651A0FFDBF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Due to the end of support for TLS 1.0, we recommended that Adobe [!UICONTROL Report Builder] (ARB) users download ARB v5.6.21 prior to September 13, 2018. <b>After that date, prior versions of ARB will no longer function</b>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_2F016FD5F356411284F939EF7FBB1D45"> 
      ...
      <li id="li_E08901A304714D83ABD1B52270A5F1D6">New typology rules filter for [!UICONTROL Mobile] App subscribers </li> 
