...
<!-- <p> 
 <note type="important">
   This page contains pre-release content and is subject to change prior to the February 8, 2018 release. 
 </note> </p> -->
...
<table id="table_558E0B0AECB84969825705EC62FA1BB2"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p>[!UICONTROL Mobile] App Engagement </p> </td> 
...
Release notes for the core services interface, including Assets, Feed, Notifications, Profiles &amp; Audiences, [!UICONTROL Mobile] Services, Launch, and Dynamic Tag Management. Also includes release information for Experience Cloud ID Service (Visitor API). 
...
<table id="table_519893D8565A4D489CB13D5EAF1E9325"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Decommissioning [!DNL Target] workflows in [!UICONTROL Mobile] Services </p> </td> 
     <td colname="col2"> <p> Beginning in March 2018, as part of disabling the Adobe [!DNL Target] workflows in Adobe [!UICONTROL Mobile] Services, the ability to create new [!DNL Target]/Activities, [!DNL Target]/Audiences, and [!DNL Target]/Content has been disabled in this release. </p> <p> You can continue to view, modify, and delete the existing Activities, Audiences, and Content until March 2018. </p> <p>For more information, see <a href="https://marketing.adobe.com/resources/help/en_US/mobile/c_mob_remove-target-faqs.html" format="html" scope="external"> Decommissioning [!DNL Target] Workflows in Mobile Services </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
