...
See [AppMeasurement Release History](https://docs.adobe.com/content/help/en/analytics/implementation/appmeasurement-updates.html) for a release history of AppMeasurement on the following platforms:
