...
|May 2022|[Create your first flow in Microsoft&reg; Power Automate](https://experienceleague.adobe.com/docs/document-services/tutorials/pdfservices/create-workflow-power-automate.html?lang=en)|Article |Learn how to create your first flow in Microsoft&reg; Power Automate using the Adobe PDF Services connector.|Document Services|
