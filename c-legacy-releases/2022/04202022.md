---
title: Central Release Notes - April 2022
...
|April 2022|[Work cross-functionally](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/administration/key-admin-skills/working-cross-functionally.html)|Video |Learn from an Adobe Analytics champion about working cross-functionally in your organization.|
...
* [!DNL Streaming Media Analytics] [release notes](https://experienceleague.adobe.com/docs/media-analytics/using/additional-resources/release-notes.html)  (**new location**)
...
* **Experience Manager Assets as a Cloud Service**
  ...
  * Experience Manager Dynamic Media now provides the flexibility to [configure one alias account](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/dynamicmedia/dm-alias-account.html) in the user interface, thus ensuring out-of-the-box [!UICONTROL Dynamic Media] URLs and Viewer Embed code are updated. This update positively impacts SEO to reflect updates made to your business context, such as rebranding.
  * You can now use the Experience Manager Assets user interface to:
    * Configure the [detection of duplicate assets](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/manage-digital-assets.html#detect-duplicate-assets) in a repository.
    * Configure [adding digital watermarks](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/watermark-assets.html) to images.
...
* **Cloud Manager**
  ...
  * New accelerated [Web Tier Config pipelines](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/cicd-pipelines/introduction-ci-cd-pipelines.html#web-tier-config-pipelines) have been introduced to exclusively deploy HTTPD/dispatcher configuration.
  
    * You must be on AEM version `2021.12.6151.20211217T120950Z` or newer and [opt in to the flexible mode of the Dispatcher tools](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/content-delivery/disp-overview.html#validation-debug) to use this feature.
  ...
  * A new failing threshold (`< D`) has been added to the [reliability rating metric](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/test-results/code-quality-testing.html#understanding-code-quality-rules).
  ...
  * The severity of the BannedPath [quality rule](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/test-results/code-quality-testing.html#understanding-code-quality-rules) has been changed from blocker to critical.
  * The pipeline wizard informs the user when an Experience Manager environment update may be needed before configuring a [Web Tier Config pipeline](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/cicd-pipelines/introduction-ci-cd-pipelines.html#web-tier-config-pipelines) associated with it.
...
|April 2022|[Implement solution to save and retrieve letter instances](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/store-retrieve-letters/introduction.html)|Video |Learn how to implement using the SPI to save and retrieve letter instances of interactive communication.|AEM Forms|
...
|April 2022|[Integrate AEM Forms with [!DNL ServiceNow]](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/some-useful-integrations/service-now.html)|Video |Create and display incident in ServiceNow using Form Data Model in AEM Forms.|AEM Forms  |
...
|April 2022|[[!DNL Site-Wide Analysis Tool]](https://experienceleague.adobe.com/docs/commerce-operations/tools/site-wide-analysis-tool/intro.html)|Documentation |Comprehensive information about the [!DNL Site-Wide Analysis] Tool, including its uses, the installation process, and getting access.|Adobe Commerce |
...
|April 2022|[Audit Trail](https://experienceleague.adobe.com/docs/campaign-learn/tutorials/monitoring/audit-trail.html)|Video |Learn how to access the Audit Trail logs and which settings can be configured.|Campaign v8 |
...
|April 2022|[Assets Essentials Overview](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/assets-essentials-overview.html)|Video |Get an overview over the Assets Essentials features and how it can be used in Adobe Journey Optimizer.|
|April 2022|[Overview over the journey canvas](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/create-journeys/overview-over-the-journey-canvas.html)|Video |Understand the features & capabilities of the Journey Canvas.|
...
|April 2022|[Create tags](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/decision-management-configuration/create-tags.html)|Video |Learn how to create tags in Offer Decisioning. Tags are optional building block components of offers. They can be used to organize offers and group them in dynamic collections.|
