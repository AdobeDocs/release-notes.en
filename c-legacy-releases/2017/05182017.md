...
[Understanding ID Synchronization and Match Rates](https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid-match-rates.html) includes new information about the ` cm.eversttech.net` call the ID service makes to [!DNL  Adobe Advertising Cloud]. 
