...
# Adobe Experience Cloud release notes - May 2019
...
| **Data Collection:** New s_ecid cookie  | Added a new [first-party server cookie](https://docs.adobe.com/content/help/en/core-services/interface/ec-cookies/cookies-analytics.html), s_ecid, in which data collection stores the visitor's ECID. |
