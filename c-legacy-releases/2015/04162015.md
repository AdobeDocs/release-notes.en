...
* A known issue is preventing audience sharing from report suites which are not owned by the linked [!DNL [!DNL Analytics]] account. Remedial efforts are underway
...
* We updated our initial loading of [!DNL  [!DNL Analytics]] apps to improve the speed of the login process.
...
### New Features in [!DNL [!DNL Analytics]] {#features_analytics}
