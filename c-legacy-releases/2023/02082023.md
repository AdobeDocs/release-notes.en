...
>[!IMPORTANT]
>
>Adobe recommends that you to [upgrade to the latest 1.9.6 version](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/integrations/workfront-connector-install.html?lang=en) of the [!DNL Workfront] for Experience Manager enhanced connector.
