...
Revised ID service implementation procedures for [!DNL  Analytics] customers. See [Set Up the Marketing Cloud ID Service with Analytics](https://docs.adobe.com/content/help/en/id-service/using/home.html). 
