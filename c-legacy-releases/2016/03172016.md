...
Revised ID service implementation procedures for [!DNL  Analytics] customers. See [Set Up the Marketing Cloud ID Service with Analytics](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-setup-analytics.html). 
