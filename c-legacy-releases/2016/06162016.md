...
<table id="table_D919A080718349AA83775BEB256B7C4A"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>The ID service encodes the MID value returned from the server or when it's set by the <span class="codeph"> visitor.setMarketingCloudVisitorID() </span> function. For more information about the MID, see <a href="https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid_cookies.html.html" format="https" scope="external"> Cookies and the Marketing Cloud ID </a>. (AAM-23336) </p> </td> 
  </tr> 
 </tbody> 
</table>
...
See [Marketing Cloud ID Service](https://docs.adobe.com/content/help/en/id-service/using/home.html) product documentation. 
...
<!-- <draft-comment> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>See <a href="https://marketing.adobe.com/resources/help/en_US/insight/whatsnew/c_release_notes_insight_62.html" format="http" scope="external"> Data Workbench 6.2 updates </a> for additional release information. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* [Capturing Campaign Impression Data via Pixel Calls](https://marketing.adobe.com/resources/help/en_US/aam/c_doc_updates.html)
* [Beta Environment](https://marketing.adobe.com/resources/help/en_US/aam/beta_environment.html)
