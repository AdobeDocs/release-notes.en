...
>[!IMPORTANT]
>
>Using Marketing Cloud ID service Library 1.9.0+, ID synching will begin for Adobe Advertising Cloud by default. See[Understanding ID Synchronization and Match Rates](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-match-rates.html). 
...
* **(Updated 10/28, 11/4)** The ID service automatically synchronizes [!DNL  Marketing Cloud] IDs (MIDs) with [!DNL  Adobe Advertising Cloud] and other internal [!DNL  Adobe] domains directly on the page. Automatic synchronization is enabled for all existing and new accounts. This helps improve match rates for [!DNL  Advertising Cloud]. Applies to VisitorAPI.js version 1.9, or higher. See also, [Understanding ID Synchronization and Match Rates](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-match-rates.html). (MCID-152, MCID-184)
...
### [!DNL Analytics] Administration API 1.4 Updates {#section_49B92A9AB47947D28B0DF5BEF6441F67}
